...
function FinalSlide({ code, matchPercentage, participantA, participantB, questionResults, t }: any) {
  ...
  return (
    <div className="w-full max-w-lg space-y-6 animate-fadeIn relative">
      ...
      {/* Download image for Telegram/Instagram - Primary */}
      <button 
        onClick={downloadStories} 
        className="w-full py-4 rounded-2xl bg-gradient-to-r from-[#0088cc] via-[#229ED9] to-[#0088cc] text-white font-bold uppercase tracking-widest text-center hover:scale-[1.02] transition-all flex items-center justify-center gap-3"
      >
